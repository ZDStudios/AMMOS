...
Gives Claude Desktop the ability to write, compile, and deliver Minecraft Forge mod JARs — all from chat.
...
```json
{
  "mcpServers": {
    "minecraft-builder": {
      "command": "node",
      "args": ["C:\\Users\\Zayn\\Desktop\\MCP-MC-MOD-MAKER\\server.js"]
    }
  }
}
```
